...
class GeneralSettingAdmin(admin.ModelAdmin):
    list_display = ['ads_per_page', 'max_recent_search_terms', 'num_of_careers_to_generate', 'last_updated']
    list_editable = ['ads_per_page', 'max_recent_search_terms', 'num_of_careers_to_generate']
